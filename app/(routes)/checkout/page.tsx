...
export default function CheckoutPage() {
  ...
  return (
    <div style={{ maxWidth: 400, margin: "0 auto" }}>
      <h1  className="w-full bg-blue-500 text-xl hover:bg-blue-600 text-white font-bold mb-4 text-center py-2 px-4 rounded">Checkout</h1>
...
function PaymentForm() {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <PaymentElement />
      <button type="submit" className="w-full bg-blue-500  text-xl hover:bg-blue-600 text-white font-bold mt-4 py-2 px-4 rounded"
