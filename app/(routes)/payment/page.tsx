...
const RentalForm = () => {
  return (
    <div className="min-h-screen bg-gray-100 flex justify-center items-center">
      <div className="container mx-auto p-6 bg-white my-4 shadow-lg">
...
<section className="py-4 px-5 border rounded-lg bg-white">
  ...
  <div className="space-y-4 border rounded-lg bg-[#F6F7F9] p-4">
    ...
    <div className="my-4 flex justify-between items-center">
      <div>
        <input type="radio" name="paymentType" id="credit-card" defaultChecked />
    ...
    <div className="grid sm:grid-cols-2 gap-4">
      <div>
        <label htmlFor="cardNumber" className="block text-base font-semibold mb-2">
          Card Number
        </label>
        <input
          type="text"
      ...
      <div>
        <label htmlFor="expiryDate" className="block text-base font-semibold mb-2">
          Expiry Date
        </label>
        <input
          type="date"
      ...
      <div>
        <label htmlFor="cardHolder" className="block text-base font-semibold mb-2">
          Card Holder
        </label>
        <input
          type="text"
      ...
      <div>
        <label htmlFor="cvc" className="block text-base font-semibold mb-2">
          CVC
        </label>
        <input
          type="text"
