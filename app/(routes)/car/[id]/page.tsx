...
//   reviews: number;
//   imageUrl: string;
//   interiorImages: string[]; // Ensure this is defined as an array
// }
...
//       {/* Left Section - Car Image & Highlights */}
//       <div>
//         <div className="bg-blue-600 text-white p-6 rounded-lg">
//           <h1 className="text-2xl font-bold">{car.name}</h1>
//           <p className="mt-2">{car.description}</p>
//           <img src={car.imageUrl} alt={car.name} className="mt-4 w-full rounded-lg" />
//         </div>

//         {/* Thumbnail Images */}
//         {/* <div className="flex gap-4 mt-4">
        
//           {car.interiorImages && Array.isArray(car.interiorImages) && car.interiorImages.length > 0 ? (
//             car.interiorImages.map((img, index) => (
//               <img key={index} src={img} alt={`Interior ${index + 1}`} className="w-24 h-24 rounded-lg cursor-pointer" />
//             ))
//           ) : (
...
//         <p className="text-gray-500">{car.brand} - {car.type}</p>
//         <div className="flex items-center mt-2">
//           <span className="text-yellow-400 text-lg">⭐ {car.rating}</span>
...
//           <p><strong>Type Car:</strong> {car.type}</p>
...
//         {/* Price & Rent Button */}
//         <div className="mt-6">
//           <span className="text-xl font-bold text-blue-600">${car.pricePerDay}/days</span>
//           {car.originalPrice && (
//             <span className="text-sm text-gray-400 line-through ml-2">${car.originalPrice}</span>
//           )}
//           <button className="bg-[#3563E9] text-white px-6 py-3 mt-4 rounded-lg hover:bg-blue-700 w-full">
//             Rent Now
//           </button>
//         </div>
//       </div>
...
//               {car.name} with the best <br /> design and acceleration
//             </h1>
...
//             <span className="ml-2 font-semibold text-xl text-[#596780]">{car.fuelCapacity}L</span>
//           </div>
//         </div>
...
export default function CarDetailPage() {
  ...
  const fetchCar = useCallback(async () => {
    ...
    const selectedCar = cars.find((c) => c._id === id) || null;
    setCar(selectedCar);
  }, [id]);
