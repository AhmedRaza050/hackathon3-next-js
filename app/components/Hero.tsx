...
const HeroSection = () => {
  return (
    <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4 p-8">
      {/* First Card */}
      ...
      {/* Second Card */}
      <div className="bg-[#3563E9] max-w-[640px] h-[360px] text-white rounded-[10px] flex flex-col items-start justify-between p-5 relative">
        <div className="flex-1">
          <h1 className="mb-4 font-medium text-[31px] leading-10 tracking-tight text-left">
