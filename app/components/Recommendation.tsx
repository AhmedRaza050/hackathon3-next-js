...
//           overflow-x-auto lg:overflow-x-hidden px-4 py-4"
//       >
//         {cars.map((car) => (
//           <div
//             key={car.name}
...
//                 gap-2 text-sm text-gray-600 mt-2 mr-3"
//             >
...
//       const limitedCars = data.slice(4, 12); // Limit to 4 products
//       setCars(limitedCars);
//       setFavorites(
...
const Recomendation = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      setCars(limitedCars);
      setFavorites(
        limitedCars.reduce<{ [key: string]: boolean }>(
